  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2 text-center">
        <h1 className="font-bold text-2xl md:text-3xl tracking-tight text-gray-800">Welcome to HealthCare</h1>
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start space-x-3 p-4 rounded-lg bg-primary/5 border border-primary/10">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Get healthcare recommendations tailored to your needs</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3 p-4 rounded-lg bg-primary/5 border border-primary/10">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Complete your profile in less than 3 minutes</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-3 p-4 rounded-lg bg-primary/5 border border-primary/10">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Your health information is protected with top-tier security standards</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-xs text-center text-muted-foreground">
          By continuing, you agree to our <a href="#" className="underline text-primary">Terms of Service</a> and <a href="#" className="underline text-primary">Privacy Policy</a>
        </p>
      </div>
    </div>
  );
